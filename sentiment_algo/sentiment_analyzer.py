...
REDDIT_INPUT_DIR = os.path.join(SCRIPT_DIR, "daily_comments")
TWITTER_INPUT_DIR = os.path.join(SCRIPT_DIR, "daily_tweets")
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "daily_sentiment")
