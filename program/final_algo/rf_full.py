...
# Start 3 months in to have three-month rolling sums used in Buyer Change and Trade Direction
start_index = data.index[data["date"] >= first_date + pd.DateOffset(months=3)][0]
end_index = data.index[data["date"] < pd.Timestamp(END_DATE)][-1]
